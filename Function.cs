...
namespace Converter
{
    public class Function
    {
        ...
        public List<string> CheckStationConfigFile(string assemblyNumber)
        {
        ...
        public string BackUpfolder(string backupPath, string categoryName)
        {
            ...
            string CategoryFolder = backupPath + "/" + categoryName + "/";
        ...
        public string GetCustomer(string strCustomerPrefix)
        {
            string customer = "";
